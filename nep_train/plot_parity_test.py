...
fig.tight_layout()
fig.savefig("parity_energy_test.pdf", bbox_inches="tight", pad_inches=0)
fig.savefig("parity_energy_test.png", bbox_inches="tight", pad_inches=0)
plt.show()
plt.close(fig)
...
fig.tight_layout()
fig.savefig("parity_force_test.pdf", bbox_inches="tight", pad_inches=0)
fig.savefig("parity_force_test.png", bbox_inches="tight", pad_inches=0)
plt.show()
plt.close(fig)
...
fig.tight_layout()
fig.savefig("parity_stress_test.pdf", bbox_inches="tight", pad_inches=0)
fig.savefig("parity_stress_test.png", bbox_inches="tight", pad_inches=0)
plt.show()
plt.close(fig)
