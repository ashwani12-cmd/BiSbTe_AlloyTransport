...
fig.tight_layout()
fig.savefig("parity_energy.pdf", bbox_inches="tight", pad_inches=0)
fig.savefig("parity_energy.png", bbox_inches="tight", pad_inches=0)
plt.show()
plt.close(fig)
...
fig.tight_layout()
fig.savefig("parity_force.pdf", bbox_inches="tight", pad_inches=0)
fig.savefig("parity_force.png", dpi=300, bbox_inches="tight", pad_inches=0)
plt.show()
plt.close(fig)
...
fig.tight_layout()
fig.savefig("parity_stress.pdf", bbox_inches="tight", pad_inches=0)
fig.savefig("parity_stress.png", bbox_inches="tight", pad_inches=0)
plt.show()
plt.close(fig)
