...
stress = np.loadtxt("stress_train.out")
...
print(f"Train  Energy RMSE: {rmse_e*1000:.3f} meV/atom")
print(f"Train  Force  RMSE: {rmse_f*1000:.3f} meV/Å")
print(f"Train  Stress RMSE: {rmse_s:.4f} GPa")

# ============================================================
# 1 — ENERGY PARITY (TRAIN)
# ============================================================
...
ax.text(0.20, 0.10, f"RMSE = {rmse_e*1000:.2f} meV/atom",
...
fig.tight_layout()
fig.savefig("parity_energy_train_100k.pdf", bbox_inches="tight", pad_inches=0)
fig.savefig("parity_energy_train_100k.png", dpi=300, bbox_inches="tight", pad_inches=0)
plt.close(fig)
print("Saved: parity_energy_train_100k")

# ============================================================
# 2 — FORCE PARITY (TRAIN)
# ============================================================
fig, ax = plt.subplots(figsize=(5, 5))
for i in range(3):
...
ax.text(0.25, 0.10, f"RMSE = {rmse_f*1000:.2f} meV/Å",
        transform=ax.transAxes)
leg = ax.legend(loc="upper left", frameon=True, fancybox=False, framealpha=0.85)
leg.get_frame().set_edgecolor("black"); leg.get_frame().set_linewidth(1.0)
fig.tight_layout()
fig.savefig("parity_force_train_100k.pdf", bbox_inches="tight", pad_inches=0)
fig.savefig("parity_force_train_100k.png", dpi=300, bbox_inches="tight", pad_inches=0)
plt.close(fig)
print("Saved: parity_force_train_100k")

# ============================================================
# 3 — STRESS PARITY (TRAIN)
# ============================================================
fig, ax = plt.subplots(figsize=(5, 5))
for i in range(6):
...
ax.text(0.25, 0.10, f"RMSE = {rmse_s:.3f} GPa",
        transform=ax.transAxes)
leg = ax.legend(loc="upper left", frameon=True, fancybox=False, framealpha=0.85)
leg.get_frame().set_edgecolor("black"); leg.get_frame().set_linewidth(1.0)
fig.tight_layout()
fig.savefig("parity_stress_train_100k.pdf", bbox_inches="tight", pad_inches=0)
fig.savefig("parity_stress_train_100k.png", dpi=300, bbox_inches="tight", pad_inches=0)
plt.close(fig)
print("Saved: parity_stress_train_100k")

print("\nAll train parity plots done!")
